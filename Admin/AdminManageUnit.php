    ...
    <section class="content-section">
		...
		<table class="table_displayData">
			...
			<tr>
				...
				<td> <a href="AdminEditUnit.php?id=<?php echo $row_selectUnit['id']; ?>"><span class="material-icons">settings</span></a> </td>
			</tr>
			<?php $i++; } ?>
		</table>
		<input type="submit" value="Delete" class="submit_button"/>
		<a href="#.php"><input type="button" value="+ Add Unit" class="submit_button"/></a>
		</form>
	</section>
</body>
</html>