		...
		if($_SESSION['admin_login'] == true) {
			...
			if($_SERVER['REQUEST_METHOD'] == "POST") {
				if(isset($_POST['chkId'])) {
					...
					if(!$result) {
						echo "<script> alert(\"There was some problems deleting Employee\"); </script>";
						header('Refresh:0');
					}
					else {
...
<body>
    <div class="sidebar">
        ...
        <ul class="nav-links">
            ...
            <li>
                <a href="AdminEmployee.php" class="active">
    ...
    <section class="content-section">
		...
		<table class="table_displayData">
			...
			<tr>
				...
				<td> <a href="edit_manufacturer.php?id=<?php echo $row_selectManufacturer['man_id']; ?>"><span class="material-icons">settings</span></a> </td>
			</tr>
			<?php $i++; } ?>
		</table>
